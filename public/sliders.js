...
function slide3In() {
    ...
    const slide1W9ab = document.querySelectorAll('.projects-page');
    for (let i = 0; i < slide1W9ab.length; i++) {   
        slide1W9ab[i].style.display = 'flex';
    }

    //Adding display back.
    const slide1W9a = document.querySelectorAll('.projects-page');
        for (let i = 0; i < slide1W9a.length; i++) {   
        slide1W9a[i].style.display = 'block';
        }
    //Change animation name to input.
    const slide1W = document.querySelectorAll('.projects-wrapper');
    for (let i = 0; i < slide1W.length; i++) {   
...
//For closing slide3. 
        ...
        //Change animation name to remove chart
        const slide1W11 = document.querySelectorAll('.projects-wrapper');
        for (let i = 0; i < slide1W11.length; i++) {   
